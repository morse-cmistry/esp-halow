...
UBaseType_t rtos_prio[] = {CONFIG_MMOSAL_TASK_PRI_IDLE, CONFIG_MMOSAL_TASK_PRI_MIN,
                           CONFIG_MMOSAL_TASK_PRI_LOW, CONFIG_MMOSAL_TASK_PRI_NORM,
                           CONFIG_MMOSAL_TASK_PRI_HIGH};
...
{
    TaskHandle_t handle;
    UBaseType_t freertos_priority = rtos_prio[priority];
